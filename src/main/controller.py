...
from queue_ import Queue #Importowanie Klasy Kolejki
from pygame import mixer # Importowanie mixera, który służy do odtwarzania muzyki
import sys
sys.path.insert(1, '../jsons')
from Import_from_file import Importer
#from src.jsons.Import_from_file import Importer # Importowanie importera do jsona
class Controler:
    def __init__(self):
